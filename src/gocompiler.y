...
%%
    Program:
    	PACKAGE ID SEMICOLON Declarations										{$$ = root = create_node(-1, "Program");
    															push($$->children, $4);}
    	|
    ...
    Declarations:
    	...
    	VarDeclaration SEMICOLON Declarations										{$$ = $1;
    															push($$->siblings, $3);}
    	|
    	FuncDeclaration SEMICOLON											{$$ = create_node(0, "FuncDecl");
    															push($$->children, $1);}
    	|
    	FuncDeclaration SEMICOLON Declarations										{$$ = create_node(0, "FuncDecl");
    															push($$->children, $1);
    															push($$->siblings, $3);}
    	;
    ...
    VarSpec:
    	ID VarSpec_1													{$$ = create_node(0, "VarDecl");
    ...
    VarSpec_1:
    	Type														{$$ = $1;}
    	|
     	COMMA ID VarSpec_1												{$$ = create_node(0, "VarDecl");
     															push($$->children, create_node(0, $2));
     															push($$->children, $3);}
     	;
	...
	FuncHeader:
		FUNC ID LPAR RPAR											{$$ = create_node(0, $2);
															push($$->siblings, create_node(0, "FuncParams"));}
    	|
    	FUNC ID LPAR Parameters RPAR											{$$ = create_node(0, $2);
    															push($$->siblings, create_node(0, "FuncParams"));
															push($$->siblings->next->data->children, $4);}
    	|
    	FUNC ID LPAR RPAR Type												{$$ = create_node(0, $2);
    															push($$->siblings, $5);
    															push($$->siblings, create_node(0, "FuncParams"));}
    	|
    ...
    FuncDeclaration:
    	FuncHeader FuncBody												{$$ = create_node(0, "FuncHeader");
    															push($$->children, $1);
    															push($$->siblings, $2);}
    	;

    Parameters:
    	ID Type														{$$ = create_node(0, "ParamDecl");
    															push($$->children, $2);
    															push($$->children, create_node(0, $1));}
    	|
    	ID Type Parameters_1                                        							{$$ = create_node(0, "ParamDecl");
    															push($$->children, $2);
    															push($$->children, create_node(0, $1));
    															push($$->siblings, $3);}
	;
    ...
    Parameters_1:
    	COMMA ID Type													{$$ = create_node(0, "ParamDecl");
    															push($$->children, $3);
    															push($$->children, create_node(0, $2));}
    	|
    	COMMA ID Type Parameters_1											{$$ = create_node(0, "ParamDecl");
    															push($$->children, $3);
    															push($$->children, create_node(0, $2));
    															push($$->siblings, $4);}
    	;
    ...
    FuncBody:
    	...
    	|
    	LBRACE VarsAndStatements RBRACE                      								{$$ = create_node(0, "FuncBody");
    															push($$->children, $2);}
    	;
    ...
    Statement:
    	ID ASSIGN Expr                                                      						{$$ = create_node(0, "Assign");
    															push($$->children, create_node(0, $1));
    															push($$->children, $3);}
    	;
    ...
    Statement:
    	...
    	|
    	LBRACE Statement_1 RBRACE                                       						{$$ = create_node(5, "Block");
    															push($$->children, $2);}
    	;
    ...
    Statement:
     	...
     	;
    OPT_ELSE:
	ELSE LBRACE Statement_rep RBRACE 										{$$ = create_node(0, "Block");
															push($$->children, $3);}
	|
    ...
    Statement:
	FOR LBRACE Statement_rep RBRACE 										{$$ = create_node(0, "For");
															push($$->children, create_node(0, "Block"));
															push($$->children->next->data->children, $3);
															}
	|
	FOR Expr LBRACE Statement_rep RBRACE 										{$$ = create_node(0, "For");
															push($$->children, $2);
															push($$->children, create_node(0, "Block"));
															push($$->children->next->next->data->children, $4);
															}
    ...
    Statement:
    	...
    	|
    	RETURN Expr                                                 							{$$ = create_node(0, "Return");
    															push($$->children, $2);}
    	;
    ...
    Statement:
    	PRINT LPAR Expr RPAR 												{$$ = create_node(0, "Print");
    															push($$->children, $3);}
    	|
    	PRINT LPAR STRLIT RPAR                                          						{$$ = create_node(0, "Print");
    															push($$->children, create_node(0, $3));}
    	;
    ...
    ParseArgs:
    	ID COMMA BLANKID ASSIGN PARSEINT LPAR CMDARGS LSQ Expr RSQ RPAR                        				{$$ = create_node(0, "ParseArgs");
															push($$->children, create_node(0, $1));
															push($$->children, $9);
															}
    	;
    ...
    FuncInvocation:
    	ID LPAR RPAR 													{$$ = create_node(0, "Call");
    															push($$->children, create_node(0, $1));}
    	|
	ID LPAR Expr RPAR 												{$$ = create_node(0, "Call");
															push($$->children, create_node(0, $1));
															push($$->children, $3);}
	|
	ID LPAR Expr FuncInvocation_rep RPAR										{$$ = create_node(0, "Call");
															push($$->children, create_node(0, $1));
															push($$->children, $3);
															push($$->children, $4);}
	;
    ...
    Expr:
    	Expr OR Expr 													{$$ = create_node(0, "Or");
    															push($$->children, $1);
    															push($$->children, $3);}
    	|
    	Expr AND Expr                                                							{$$ = create_node(0, "And");
    															push($$->children, $1);
    															push($$->children, $3);}
    	;

    Expr:
    	Expr LT Expr													{$$ = create_node(0, "Lt");
    															push($$->children, $1);
    															push($$->children, $3);}
    	|
    	Expr GT Expr													{$$ = create_node(0, "Gt");
															push($$->children, $1);
															push($$->children, $3);}
    	|
    	Expr LE Expr													{$$ = create_node(0, "Le");
															push($$->children, $1);
															push($$->children, $3);}
    	|
    	Expr GE Expr													{$$ = create_node(0, "Ge");
															push($$->children, $1);
															push($$->children, $3);}
    	|
    	Expr EQ Expr													{$$ = create_node(0, "Eq");
															push($$->children, $1);
															push($$->children, $3);}
    	|
    	Expr NE	Expr													{$$ = create_node(0, "Ne");
															push($$->children, $1);
															push($$->children, $3);}
    	;

    Expr:
    	Expr PLUS Expr													{$$ = create_node(0, "Add");
															push($$->children, $1);
															push($$->children, $3);}
    	|
    	Expr MINUS Expr													{$$ = create_node(0, "Sub");
															push($$->children, $1);
															push($$->children, $3);}
    	|
    	Expr STAR Expr													{$$ = create_node(0, "Mul");
															push($$->children, $1);
															push($$->children, $3);}
    	|
    	Expr DIV Expr													{$$ = create_node(0, "Div");
															push($$->children, $1);
															push($$->children, $3);}
    	|
    	Expr MOD Expr                             									{$$ = create_node(0, "Mod");
    															push($$->children, $1);
    															push($$->children, $3);}
    	;

    Expr:
    	NOT Expr													{$$ = create_node(0, "Not");
    															push($$->children, $2);}
    	|
    	MINUS Expr %prec NOT												{$$ = create_node(0, "Minus");
    															push($$->children, $2);}
    	|
    	PLUS Expr %prec NOT /*unary minus/plus has the same priority as the not operator */				{$$ = create_node(0, "Plus");
    															push($$->children, $2);}
    	;
